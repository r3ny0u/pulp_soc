...
package custom_axi_ip_reg_pkg;
  ...
  // Register offsets
  parameter logic [BlockAw-1:0] CUSTOM_AXI_IP_REG0_OFFSET = 4'h 0;
  parameter logic [BlockAw-1:0] CUSTOM_AXI_IP_REG1_OFFSET = 4'h 4;
  parameter logic [BlockAw-1:0] CUSTOM_AXI_IP_REG2_OFFSET = 4'h 8;
  ...
  parameter logic [3:0] CUSTOM_AXI_IP_PERMIT [3] = '{
    4'b 1111, // index[0] CUSTOM_AXI_IP_REG0
    4'b 1111, // index[1] CUSTOM_AXI_IP_REG1
    4'b 1111  // index[2] CUSTOM_AXI_IP_REG2
  };
